function getGoogle() {
	...
	xhr.open("GET", "http://7c17463f1596fe090e72-72cc7b7e3d1bfe016e789931389f4585.r49.cf2.rackcdn.com/xml/googleAgreement.xml", true); 		// should probably pass file name as a variable
	xhr.send();
